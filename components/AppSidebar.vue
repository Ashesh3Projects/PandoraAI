...
const setCurrentConversationTitleHandler = () => {
    let conversationTitle = prompt('Enter conversation title:');
...
<template>
    <div
        class="
            flex flex-col bg-[#1e1d1d] flex-1 max-w-xs shadow-lg
    ...
    >
        ...
        <div class="p-3 pb-0">
            <!-- New Chat -->
            <button @click="startNewConversationHandler" class="
                        flex flex-row items-center w-full bg-white/5 rounded shadow p-3 mb-3
                        transition duration-300 ease-in-out
                        hover:bg-white/10
                    " :disabled="!!processingController" :class="{ 'cursor-not-allowed': !!processingController }">
        ...
        <!-- Conversations -->
        <div class="flex-1 flex flex-col gap-1 p-3 overflow-y-auto">
        ...
        <div class="flex flex-col items-start gap-2 bg-black/10 p-6 min-h-[100px] text-sm">
            <button @click="clearConversationsHandler"
